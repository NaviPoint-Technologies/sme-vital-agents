...
- Web fetch for reading URLs and API documentation

## Source System Reconnaissance
...
answer quickly from general knowledge before falling back to web search for specifics
like current rate limits or recent API changes.
